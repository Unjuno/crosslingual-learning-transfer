...
## Performance and mechanism phase
...
Some snapshots retain `/mnt/data/...` roots from the execution environment. See `docs/REPRODUCIBILITY.md` before rerunning them. Confirmatory settings are recorded in `protocols/`; large checkpoints, raw logs, and third-party corpora are intentionally excluded.
